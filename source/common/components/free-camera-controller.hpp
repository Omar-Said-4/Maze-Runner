...
namespace our {
    ...
    public:
        ...
        glm::vec3 positionSensitivity = {5.0f, 20.0f, 20.0f}; // The unity per second of camera movement if WASD is pressed
        float speedupFactor = 5.0f; // A multiplier for the position Sensitivity if "speedUp" powerup is collected.
